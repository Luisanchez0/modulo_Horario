...
{/*
          <section className="auth-card">
            <div className="hero__badge">Acceso Seguro</div>
            <h3>{isRegisterMode ? 'Crear usuario' : 'Iniciar sesion'}</h3>
            <p>
              {isRegisterMode
          ...
          {mensaje && (
            <section className="feedback auth-feedback">
              {mensaje && <p className="feedback__ok">{mensaje}</p>}
            </section>
          )}

          {error && (
            <Modal title="Error de autenticacion" titleId="error-modal-title-auth" onClose={clearError} actions={<>
            ...
            <form onSubmit={iniciarSesion} className="form auth-form">
              ...
              <label>
                ...
                <span className="password-field">
                  ...
                  >
                    {showPassword ? (
                      <svg className="password-toggle__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                        ...
                        <path d="M14.12 14.12C12.72 15.12 11.06 15.66 9.25 15.66C5.92 15.66 3 13.5 1.5 10.5C2.7 8 5.2 6 8.25 5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
                    ) : (
                      <svg className="password-toggle__icon" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                        <path d="M1.5 12C3 15 5.92 17.16 9.25 17.16C11.06 17.16 12.72 16.62 14.12 15.62" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M21 12C19.5 9 16.58 6.84 13.25 6.84C11.44 6.84 9.78 7.38 8.38 8.38" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
...
>
  {showPassword ? (
    ...
    // Icono: mostrar contraseña (ojo normal)
    <svg
      className="password-toggle__icon"
      width="20"
      height="20"
    ...
    >
      ...
      />
          ...
          <button type="button" className="auth-switch" onClick={alternarModoAuth}>
            {isRegisterMode
